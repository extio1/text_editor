...
Row::Row(const int x, const int y, const int width, const int height, GlyphContainer::GlyphList&& list):
...
void Row::Insert(int insertPosition, std::list<GlyphPtr>&& itemsToInsert) {
