...
int main() {
    ...
    // // std::cout << "char position: " << comp.GetGlyphPosition(charPtr) <<
    // std::endl;
    // // std::cout << "button position: " << comp.GetGlyphPosition(buttonPtr)
    // << std::endl;
    // // comp.Draw();
    // // comp.MoveGlyph(1, 2);
    ...
    // std::cout << page->RowCanBeAdded(10) << " " << page->ColumnCanBeAdded(10)
    // << std::endl;
